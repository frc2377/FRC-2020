...
public class CenterStartCommandGroup extends SequentialCommandGroup {
  public CenterStartCommandGroup(
    ...
    String trajectoryJSON = "paths/Right01Start.wpilib.json"; // TODO: Use the correct json file(s) for center start
